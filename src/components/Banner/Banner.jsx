            ...
            <div className=' banner mt-10  '>
                <div className='flex  justify-center'>
                    ...
                    <div  className=' flex flex-col flex-1 justify-center relative bottom-40'>
                        <p className='text-4xl font-bold font-Sora pt-14 text-center '>Turning Ideas <br /><span>into</span> <br />
                        <span className='text-purple-900 text-5xl'>Digital Masterpieces </span><br />of Innovation</p>
                        <p className='font-Sora font-medium text-center text-xl text-slate-800 pt-10'>Access powerful developers in remote and mutually trusted setup</p>
