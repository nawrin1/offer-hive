            ...
            <form>
                ...
                <div className="md:flex mb-6 text-2xl font-Sora mt-3">
                    <div className="form-control md:w-1/2 w-full lg:w-1/2">
                        ...
                        <label className="input-group">
                            <input type="email" name="bEmail" defaultValue={user.email} placeholder="your email" disabled className="input input-bordered w-full" />
                        </label>
                    </div>
                    <div className="form-control md:w-1/2 ml-2 w-full lg:w-1/2">
                        <label className="label">
                        ...
                        <label className="input-group" >
                            <input type="email" name="taste" defaultValue={email} placeholder="buyer email" className="input input-bordered w-full" disabled/>
                        </label>
                    </div>
                </div>
